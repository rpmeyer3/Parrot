            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                    ...
                    <p className="text-muted-foreground">
                        ...
                        taking home any major hardware. I find myself involved in the HackPack. In my freetime I play a great deal of Tennis and Soccer to stay sociable and athletic. I also venture into the 
